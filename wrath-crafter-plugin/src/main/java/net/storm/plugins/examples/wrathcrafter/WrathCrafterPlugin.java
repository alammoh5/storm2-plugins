...
import net.storm.plugins.examples.wrathcrafter.tasks.*;
...
@Extension
public class WrathCrafterPlugin extends TaskPlugin {
    ...
    @Inject
    private WrathCrafterConfig config;

    @Inject
    private OverlayManager overlayManager;

    @Inject
    private WrathCrafterOverlay overlay;
    ...
    private void onConfigChanged(ConfigChanged e) {
        if (!e.getGroup().equals(WrathCrafterConfig.GROUP)) {
            return;
        }
    ...
    @Provides
    public WrathCrafterConfig provideConfig(ConfigManager configManager) {
        return configManager.getConfig(WrathCrafterConfig.class);
    }
}
