...
class InfernoWaveMappings {
    ...
    static {
        ...
        waveMapBuilder.put(22, new int[]{32, 32, 32, 165, 370});
        waveMapBuilder.put(23, new int[]{32, 32, 32, 85, 165, 370});
        waveMapBuilder.put(24, new int[]{32, 32, 32, 85, 85, 165, 370});
        waveMapBuilder.put(25, new int[]{32, 32, 32, 165, 165, 370});
        waveMapBuilder.put(26, new int[]{32, 32, 32, 240, 370});
        waveMapBuilder.put(27, new int[]{32, 32, 32, 85, 240, 370});
        waveMapBuilder.put(28, new int[]{32, 32, 32, 85, 85, 240, 370});
        waveMapBuilder.put(29, new int[]{32, 32, 32, 165, 240, 370});
        waveMapBuilder.put(30, new int[]{32, 32, 32, 85, 165, 240, 370});
        waveMapBuilder.put(31, new int[]{32, 32, 32, 85, 85, 165, 240, 370});
        waveMapBuilder.put(32, new int[]{32, 32, 32, 165, 165, 240, 370});
        waveMapBuilder.put(33, new int[]{32, 32, 32, 240, 240, 370});
        waveMapBuilder.put(34, new int[]{32, 32, 32, 370, 370});
        waveMapBuilder.put(35, new int[]{32, 32, 32, 32, 32, 32});
        waveMapBuilder.put(36, new int[]{32, 32, 32, 490});
        waveMapBuilder.put(37, new int[]{32, 32, 32, 85, 490});
        waveMapBuilder.put(38, new int[]{32, 32, 32, 85, 85, 490});
        waveMapBuilder.put(39, new int[]{32, 32, 32, 165, 490});
        waveMapBuilder.put(40, new int[]{32, 32, 32, 85, 165, 490});
        waveMapBuilder.put(41, new int[]{32, 32, 32, 85, 85, 165, 490});
        waveMapBuilder.put(42, new int[]{32, 32, 32, 165, 165, 490});
        waveMapBuilder.put(43, new int[]{32, 32, 32, 240, 490});
        waveMapBuilder.put(44, new int[]{32, 32, 32, 85, 240, 490});
        waveMapBuilder.put(45, new int[]{32, 32, 32, 85, 85, 240, 490});
        waveMapBuilder.put(46, new int[]{32, 32, 32, 165, 240, 490});
        waveMapBuilder.put(47, new int[]{32, 32, 32, 85, 165, 240, 490});
        waveMapBuilder.put(48, new int[]{32, 32, 32, 85, 85, 165, 240, 490});
        waveMapBuilder.put(49, new int[]{32, 32, 32, 165, 165, 240, 490});
        waveMapBuilder.put(50, new int[]{32, 32, 32, 240, 240, 490});
        waveMapBuilder.put(51, new int[]{32, 32, 32, 370, 490});
        waveMapBuilder.put(52, new int[]{32, 32, 32, 85, 370, 490});
        waveMapBuilder.put(53, new int[]{32, 32, 32, 85, 85, 370, 490});
        waveMapBuilder.put(54, new int[]{32, 32, 32, 165, 370, 490});
        waveMapBuilder.put(55, new int[]{32, 32, 32, 85, 165, 370, 490});
        waveMapBuilder.put(56, new int[]{32, 32, 32, 85, 85, 165, 370, 490});
        waveMapBuilder.put(57, new int[]{32, 32, 32, 165, 165, 370, 490});
        waveMapBuilder.put(58, new int[]{32, 32, 32, 240, 370, 490});
        waveMapBuilder.put(59, new int[]{32, 32, 32, 85, 240, 370, 490});
        waveMapBuilder.put(60, new int[]{32, 32, 32, 85, 85, 240, 370, 490});
        waveMapBuilder.put(61, new int[]{32, 32, 32, 165, 240, 370, 490});
        waveMapBuilder.put(62, new int[]{32, 32, 32, 85, 165, 240, 370, 490});
        waveMapBuilder.put(63, new int[]{32, 32, 32, 85, 85, 165, 240, 370, 490});
        waveMapBuilder.put(64, new int[]{32, 32, 32, 165, 165, 240, 370, 490});
        waveMapBuilder.put(65, new int[]{32, 32, 32, 240, 240, 370, 490});
        waveMapBuilder.put(66, new int[]{32, 32, 32, 370, 370, 490});
    ...
    static void addWaveComponent(InfernoConfig config, PanelComponent panelComponent, String header, int wave, Color titleColor, Color color) {
        ...
        for (int i = 0; i < monsters.length; i++) {
            ...
            String npcNameText = InfernoConfigParsers.namingDisplayMode(config) == InfernoNamingDisplayMode.SIMPLE
                ? npcNameMappingSimple.get(monsterType)
                : npcNameMappingComplex.get(monsterType);
            if (config.npcLevels()) {
